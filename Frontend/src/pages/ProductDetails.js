    ...
    <div className='container mx-auto p-4'>
      <div className='min-h-[200px] flex flex-col lg:flex-row gap-4'>     
        ...
        </div>
        {
          ...
          <p className="bg-slate-200 animate-pulse px-2 rounded-full inline-block w-fit h-6 w-full lg:h-8" ></p>
          <h2 className="text-3xl lg:text-4xl font-medium h-6 lg:h-8 bg-slate-200 w-full"></h2>
          <p className="capitalize text-slate-400 bg-slate-200 min-w-[100px] animate-pulse h-6 lg:h-8 w-full"></p>
          <div className="text-red-600 bg-slate-200 h-6 lg:h-8 animate-pulse flex items-center gap-1 w-full">
               
          </div>
          <div className="flex items-center h-6 lg:h-8 animate-pulse gap-2 text-2xl lg:text-3xl font-medium my-1h-6 animate-pulse w-full">
